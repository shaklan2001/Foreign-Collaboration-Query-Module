...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
        ...
        <!--form starts here-->
        <form action="<?php echo e(route('get-data')); ?>" method="post" enctype="multipart/form-data" id="fcs">
            <?php echo csrf_field(); ?>
                   <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm <?php $__errorArgs = ['period_from'];
...
unset($__errorArgs, $__bag); ?>" name="period_from" id="flatpickr" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                    ...
                                    <select id="approval_agency" name="approval_agency" class="form-select" autocomplete="off">
                                        <option value="" selected="selected">- Select -</option>
                                        <?php $__currentLoopData = $ApprovalAgency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($agency->AGCODE); ?>"><?php echo e($agency->AGNAME); ?></option>
...
<br>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $Countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($country->CONTCODE); ?>"><?php echo e($country->CONTNAME); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <option value = " selected= selected" >- Select -</option> 
                                <?php $__currentLoopData = $ScheduleIndustry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule_industry_post2000): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($schedule_industry_post2000->SCHCODE); ?>"><?php echo e($schedule_industry_post2000->SCHEDULE_DESCRIPTION); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">   
                                <div class="form-group">
                                    ...
                                    <option value="" selected="Not Selected">- Select -</option>
                                    <?php $__currentLoopData = $stateList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stdt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($stdt->STDT_CODE); ?>"><?php echo e($stdt->STDT_NAME); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function getval(sel)
{
    ...
    var id = sel.value;
    var Target = $('#comapny');
        var URL = "<?php echo e(route('get-Get-Company-name')); ?>";
        $.ajax({
        url: URL,
        type: 'GET',
        data: {id:id},
...
function getsub(sel)
{
    ...
    var Target = $('#sub_schedule_industry');
        var URL = "<?php echo e(route('get-sub-scheduled-industry')); ?>";
        $.ajax({
        url: URL,
        type: 'GET',
        data: {id:id},
...
function getdistrict(sel)
{
    ...
    var id = sel.value;
    var Target = $('#district');
        var URL = "<?php echo e(route('Get_district')); ?>";
        $.ajax({
        url: URL,
        type: 'GET',
        data: {id:id},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nikita laravel/laravel/resources/views/homepage.blade.php ENDPATH**/ ?>